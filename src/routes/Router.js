...
const MinimalLayout = lazy(() => import("../layouts/MinimalLayout/MinimalLayout.js"));
/****End Layouts*****/

/*****Pages******/
const Register = lazy(() => import("../views/dashboards/Register.js"));
...
const ThemeRoutes = [
  ...
  },
  {
    ...
    children: [
      { path: "login", exact: true, element: <Login /> }, // Corregido a /auth/login
      { path: "register", exact: true, element: <Register /> } // Corregido a /auth/register
    ]
  }
];
